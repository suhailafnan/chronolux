...
const loadOfferPage = async (req, res) => {
    try {
        ...
        const products = await Products.find({ is_listed: true });
        const productOffers = await productOffer.find().populate('productId').skip(skip).limit(limit);
...
const loadCategoryOfferPage = async (req, res) => {
    try {
        ...
        const categoryOffers = await categoryOffer.find().populate('categoryId').skip(skip).limit(limit);
...
const deleteCategoryOffer = async (req, res) => {
    try {
        ...
        res.json({ success: false, message: 'Failed to delete the category offer.' });
    }
};
...
const deleteProductOffer = async (req, res) => {
    try {
        ...
        console.log(error.message);
        res.json({ success: false, message: 'Failed to delete the product offer.' });
    }
};
